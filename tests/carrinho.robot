...
Clicar Via Javascript
    [Documentation]    Clica em um elemento via JavaScript, mais confiável em modo headless.
    [Arguments]    ${locator}
...
CT05 - Adicionar Produto Ao Carrinho Deve Atualizar Contador
    ...
    Clicar Via Javascript    id:add-to-cart-sauce-labs-backpack
...
CT06 - Remover Produto Do Carrinho Deve Ocultar Contador
    ...
    Clicar Via Javascript    id:add-to-cart-sauce-labs-backpack
    Wait Until Element Contains    class:shopping_cart_badge    1    timeout=10s
    Clicar Via Javascript    id:remove-sauce-labs-backpack
...
CT07 - Acessar Carrinho Vazio Sem Adicionar Produtos
    ...
    Clicar Via Javascript    class:shopping_cart_link
